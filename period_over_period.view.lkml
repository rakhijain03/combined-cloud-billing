...
#     sql:
#         CASE
#           WHEN ${gcp_billing.usage_start_date} >=  ${first_date_in_period}
#           THEN 'This {% parameter period %} to Date'
#           WHEN ${gcp_billing.usage_start_date} >= ${first_date_in_prior_period}
#           AND ${gcp_billing.usage_start_date} <= ${last_date_in_prior_period}
...
#           THEN DATE_DIFF(${gcp_billing.usage_start_date}, ${first_date_in_period}, DAY)
#           WHEN ${period_selected} = 'Prior {% parameter period %} to Date'
#           THEN DATE_DIFF(${gcp_billing.usage_start_date}, ${first_date_in_prior_period}, DAY)
#           ELSE NULL END;;
#   }
